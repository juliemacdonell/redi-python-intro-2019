# -*- coding: utf-8 -*-
"""
Created on Thu Oct 31 21:00:57 2019
...
print(f"Michael's final exam grade is")
final_grade('michael grades')
...
final_grade ['christoph'] = 87
print(f"final_grade christoph")
...
failed = {'kate', 'scott', 'alice'}
failed = all_students.diference(passed)
